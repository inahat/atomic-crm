...
export const ContractBuilder = () => {
    ...
    const processContent = (content: string, contractData: any, settingsData: any, companyData: any) => {
        ...
        const variables = {
            ...
            '{{start_date}}': contractData?.start_date ? new Date(contractData.start_date).toLocaleDateString('en-GB') : 'TBD',
            '{{expiry_date}}': contractData?.expiry_date ? new Date(contractData.expiry_date).toLocaleDateString('en-GB') : 'TBD',
